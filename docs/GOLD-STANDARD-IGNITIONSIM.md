...
- Amazon CTAs must use verified direct product pages only: `https://www.amazon.com/dp/ASIN?tag=ignitionsim-20`. Never publish Amazon search-result links (`/s?k=`, `/s?keywords=`, or generic "Check Amazon" destinations). Until Robert explicitly approves another affiliate relationship, **every purchase path and clickable product-name shopping link is Amazon-only**. If the exact ASIN cannot be verified, omit the retail CTA and leave the product name as editorial text. Official, manual, forum, and reviewer links may remain only as clearly labeled research evidence; they never carry buy language, buy styling, `data-buy-link`, or `rel=sponsored`, and they never substitute for an Amazon purchase destination.
