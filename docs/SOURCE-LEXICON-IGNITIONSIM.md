...
High-value evidence shelves used in the July 2026 rescue pass:

- Flagship direct drive: [Simucube 2 Sport](https://simucube.com/en-us/simucube-2-sport/), [Simucube 2 user guide](https://simucube.com/app/uploads/2022/11/Simucube_2_User_Guide.pdf), [Asetek Invicta](https://www.asetek.com/simsports/global/product/invicta-direct-drive-wheelbase-27nm/), [Simagic Alpha EVO Ultra](https://simagic.com/pages/detail-simagic-alpha-evo-ultra-28nm-direct-drive-wheel-base), [Fanatec ClubSport DD+](https://www.fanatec.com/us/en/p/wheel-bases/cs_dd%2B_us/clubsport-dd-plus-us), and [Fanatec firmware torque update](https://www.fanatec.com/us/en/explorer/products/racing-wheels-wheel-bases/more-torque-same-hardware/).
- Active pedals: [Simucube ActivePedal Pro](https://simucube.com/en-us/simucube-activepedal-pro/), [Simucube specifications](https://docs.simucube.com/ActivePedalPro/Specifications.html), [Simucube mounting](https://docs.simucube.com/ActivePedalPro/Mounting.html), [Simucube effects](https://docs.simucube.com/ActivePedalPro/Software/Effects.html), [MOZA mBooster](https://us.mozaracing.com/products/mbooster-active-pedal), and [MOZA support/known issues](https://support.mozaracing.com/en/support/solutions/articles/70000672500-moza-mbooster-active-pedal-support).
- Premium Foresight rooms: [GCQuad](https://www.foresightsports.com/collections/launch-monitors/products/gcquad-launch-monitor), [Falcon](https://www.foresightsports.com/products/foresight-falcon-launch-monitor), [GC3 firmware/downloads](https://support.foresightsports.com/downloads-installations-quick-access), [FSX software support](https://support.foresightsports.com/support/software), and [FSX Subscription caveats](https://support.foresightsports.com/support/software/fsx-subscription).
- Room engineering: [Uneekor resources](https://uneekor.com/support/resources), [EYE XO2 installation manual](https://download.uneekor.com/docs/EYEXO2_Installation_Manual.pdf), [BenQ projector placement](https://www.benq.com/en-us/golf-simulator-projector/knowledge/what-is-the-best-place-to-mount-a-golf-simulator-projector.html), and [BenQ throw calculation](https://www.benq.com/en-us/golf-simulator-projector/knowledge/measure-screen-size-and-distance.html).

Product media use is not assumed to be unlimited merely because an image is public. Preserve source URLs, attribution, and any press/media terms; prefer official press or product assets intended to describe the item. Community and editorial photos remain outbound evidence unless the license or permission explicitly allows local reuse.
