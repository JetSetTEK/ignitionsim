---
title: "Mounting Your HOSAS: Why Desk Baseplates Slide and Monstertech Doesn't"
description: "The under-appreciated mounting problem unique to two-stick rigs — sliding sticks under combat input — and the clamp-arm, desk, and chair solutions that actually lock them down."
bay: "space"
type: "how-to"
primaryKeyword: "HOSAS mounting solutions"
author: "Robert Pruitt"
publishDate: 2026-05-20
heroImage: "/images/space/mounting-your-hosas-monstertech.jpg"
heroAlt: "Two clamp-mounted flight sticks on a desk edge in a dark room, neon magenta and cyan ambient light"
excerpt: "Your sticks aren't the weak link in your rig — the surface they sit on is. Here's why baseplates slide under combat input and the clamp-arm fix every serious HOSAS pilot ends up buying."
featured: false
readingTime: 8
faqs:
  - q: "Why do my flight sticks slide around?"
    a: "Tabletop baseplates lose grip under aggressive combat input. The forces you apply when slamming a stick to a corner are lateral, and a stick resting on a desk has nothing resisting that sideways push but friction and its own weight, so it walks."
  - q: "What's the best way to mount two sticks?"
    a: "Monstertech-style aluminum clamp arms on a chair or desk are the community standard because they hold each stick rigid and let you set ergonomic angles. They bolt to the stick's base and clamp to the furniture, removing slide entirely."
  - q: "Do I need to mount a budget HOSAS too?"
    a: "Yes — arguably more. Lighter budget sticks like the T.16000M slide more easily than heavy metal ones, so the cheaper your sticks, the more a mount helps. The good news is light sticks don't demand the heaviest-duty mounts."
  - q: "Can I mount sticks to a chair instead of a desk?"
    a: "Yes. Chair-arm mounts put the sticks in your lap area at natural angles and move with you, which many pilots prefer over reaching forward to a desk. It's the more immersive option if your chair can take the clamps."
  - q: "Will a heavy stick stay put without a mount?"
    a: "Heavier all-metal bases resist sliding better than light plastic ones, but even they can creep under hard input over a long session. Weight reduces the problem; it doesn't eliminate it. A mount is the only thing that does."
related:
