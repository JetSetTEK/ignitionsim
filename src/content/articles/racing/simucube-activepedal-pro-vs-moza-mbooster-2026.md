...
<div class="shotgrid">
  ...
  <figure><img src="/images/curator-scenes/duke-racing-pedal-setup.webp" alt="Duke Alvarez checking sim racing pedal mounting stiffness" loading="lazy"><figcaption>Duke's rule: active feedback only feels expensive if the pedal deck does not move</figcaption></figure>
</div>
...
Source review date: July 8, 2026. Checked IgnitionSim verified product records, [Simucube ActivePedal Pro](https://simucube.com/simucube-activepedal-pro/), [MOZA Racing](https://mozaracing.com/), current Simucube/MOZA community discussions, and our existing active-pedal/load-cell guide.
