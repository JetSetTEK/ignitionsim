---
title: "MOZA R5 in 2026: Is the Cheapest Real MOZA Still Enough?"
description: "MOZA R5 review for 2026 — 5.5Nm bundle deep dive on FFB feel, what you sacrifice vs the R9 and R12, the mounting quirk, and who should actually buy it."
bay: "racing"
type: "gear-explainer"
primaryKeyword: "moza r5 review"
author: "Robert Pruitt"
publishDate: 2026-06-13
heroImage: "/images/racing/moza-r5-review-2026.jpg"
heroAlt: "Macro of a compact CNC aluminum direct-drive wheelbase with red anodized accents under raking key light"
excerpt: "5.5Nm, a clean bundle, and the door into MOZA's ecosystem. Where the R5 still punches above its price in 2026 — and the two reasons to step up."
featured: false
readingTime: 9
faqs:
  - q: "Is the MOZA R5 still worth buying in 2026?"
    a: "Yes, for the right buyer. The R5 bundle (5.5Nm base, ES wheel, SR-P Lite pedals) is a genuine direct-drive starter with excellent detail for its price and a clear upgrade ladder into MOZA's ecosystem. It's a big leap over any belt or gear wheel — but it's PC-only and its torque feels limited if you've used 8-10Nm bases."
  - q: "How much torque does the MOZA R5 have?"
    a: "The MOZA R5 produces 5.5Nm of torque. That's strong enough to feel road texture, curbs and grip clearly — noticeably stiffer than a stock road car without power steering — and plenty for GT and formula racing, but below the 9-12Nm enthusiast sweet spot."
  - q: "MOZA R5 vs R9 vs R12 — which should I buy?"
    a: "Buy the R5 (5.5Nm) to spend less upfront and resell cheaply if you upgrade later; the R9 (9Nm) for the FFB sweet spot at similar money; the R12 (12Nm) for the practical ceiling plus extra ports and full compatibility with all current MOZA rims. The R5 makes most sense if budget or cockpit size is tight."
  - q: "Does the MOZA R5 work on console?"
    a: "No — the MOZA R5 is PC-only. If you need direct drive on Xbox, MOZA's R3 is the console option; for PS5, look to Fanatec. Only buy the R5 if you race on PC."
related:
...
1. **It's PC-only.** No console support at all. If you touch PS5 or Xbox, the R5 is off the table — look at the [console direct-drive options](/racing/console-direct-drive-2026) instead.
2. **The mounting pattern is uncommon.** Several owners report the R5's bolt pattern doesn't line up cleanly on every rig or stand, causing alignment headaches. **Confirm your cockpit or stand supports it before you buy.**
...
- **Upgrade the pedals before the base.** The SR-P Lite set is the weakest link — a load-cell brake will improve your consistency more than another few Nm. This is the [pedals-over-power](/racing/pedals-over-power) principle in action.
- **Run it on a rigid mount.** 5.5Nm won't destroy a solid desk, but it'll lift a flimsy one — see [desk vs cockpit](/racing/desk-vs-cockpit-sim-racing-2026) for the thresholds.
