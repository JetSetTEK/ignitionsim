---
title: "Professional Ship Simulator 2026 Hardware Setup Guide: Build a Rig for the 9-Axis Bridge"
description: "Professional Ship Simulator launches in 2026 with 100+ buttons and 9 axes. Here is the honest hardware plan to map a real bridge before you spend a dollar."
bay: "marine"
type: "how-to"
primaryKeyword: "Professional Ship Simulator hardware setup"
author: "Robert Pruitt"
publishDate: "2026-06-13"
heroImage: "/images/marine/professional-ship-simulator-2026-hardware-setup.jpg"
heroAlt: "Darkened ship bridge console at dusk with glowing teal radar and chart displays and brushed-metal control levers"
excerpt: "Aerosoft and SWE Systems built Professional Ship Simulator around 100+ mappable buttons and 9 axes. For the first time in this niche, the sim is the hardware-friendly part. Here is how to map a bridge to it without overbuying."
featured: true
readingTime: 8
faqs:
  - q: "What controllers does Professional Ship Simulator support?"
    a: "Aerosoft confirms support from gamepad to joystick, with a fully clickable cockpit, 100+ mappable buttons, and around 9 control axes, plus a rudder deadzone option for HOTAS and controller rigs. It is the most input-flexible marine sim announced for PC."
  - q: "Do I need a dedicated ship's helm to play Professional Ship Simulator?"
    a: "No. The clickable cockpit means a mouse runs every switch out of the box. Physical hardware adds feel, not function — start with a gamepad or a flight throttle quadrant and add levers only if you want them."
  - q: "Will my flight sim throttle quadrant work for the ship's engine telegraph?"
    a: "It should. A 9-axis input model has room for twin engine throttles plus a bow thruster, which is exactly what a Logitech Saitek or Thrustmaster TWCS quadrant provides. Confirm axis assignment after Early Access ships, since per-ship bindings can vary."
  - q: "How much should I budget for a Professional Ship Simulator rig?"
    a: "Around $0 to start (mouse plus a pad you own), roughly $60 to 130 for a throttle quadrant, and $150 to 400 if you add a button box and a HOTAS stick for the rudder. There is no need for a $349 racing wheel here."
  - q: "When does Professional Ship Simulator release?"
    a: "It is scheduled for Steam Early Access in 2026, developed by SWE Systems and published by Aerosoft. Treat any pre-launch binding advice as provisional until the input menu is final."
related:
...
| Bridge function | Best hardware to map it to | Approx. cost | Axes/inputs used |
|---|---|---|---|
| Helm / steering | **Gamepad stick** or **Logitech G29** wheel | $0–$300 | 1 axis |
| Twin engine throttles | **Logitech Saitek Pro Flight Throttle Quadrant** | ~$60–$80 | 2 axes |
| Bow / stern thruster | Third quadrant lever or **second Saitek unit** | ~$60–$80 | 1–2 axes |
| Rudder (HOTAS rigs) | **Thrustmaster T.16000M** stick or rudder pedals | ~$60–$130 | 1 axis (deadzone-tuned) |
| Switches, lights, telegraph stages | **Button box** (DIY or commercial) | $30–$150 | 20–100+ buttons |
...
- **Sailing-sim purists.** PSS is ship-handling and bridge work — commercial vessels, not yachts. If your interest is trimming sails, this is the wrong title; start with our [marine sim hardware reality check](/marine/marine-sim-hardware-reality) and look at eSail or Sailaway instead.
